...
PAYMENT_CHANNEL = environ.get('PAYMENT_CHANNEL', "") #add payment channel here including the '@' sign
# Bot settings
...
STREAM_API = (environ.get('STREAM_API', '2GaWr7Gej6OytncwbStlnm9lDO72'))
...
Per_Refer = 1.000 #add per refer bonus here
...
SHORTLINK_API = environ.get('SHORTLINK_API', '2GaWr7Gej6OytncwbStlnm9lDO72')
...
URL = "https://miadidi-1564d8a6589a.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://miadidi-1564d8a6589a.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://miadidi-1564d8a6589a.herokuapp.com/".format(FQDN)
else:
    URL = "https://miadidi-1564d8a6589a.herokuapp.com/".format(FQDN)
